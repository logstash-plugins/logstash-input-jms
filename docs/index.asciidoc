...
--------------------------------------------------
 input
 {
    jms {
       ...
       username => 'username' <5>
       password => 'secret' <5>
       keystore => '/Users/logstash-user/security/keystore.jks' <6>
       keystore_password => 'another_secret' <6>
       truststore => '/Users/logstash-user/security/truststore.jks' <6>
       truststore_password => 'yet_another_secret' <6>
       include_header => false  <7>
       include_properties => false <7>
       include_body => true <7>
       use_jms_timestamp => false <8>
...
<7> Parts of the JMS Message to include in the event - headers, properties and the message body can be included or
    excluded from the event.
<8> Determines whether the JMSTimestamp header is used to populate the `@timestamp` field.
...
--------------------------------------------------
 input {
    jms {
        include_header => false <1>
        include_properties => false <1>
        include_body => true <1>
        use_jms_timestamp => false <1>
        interval => 10 <1>
...
===== Sample Configuration for Non-JNDI Connection using Logstash Configuration and Yaml file
...
===== Sample Configuration for JNDI Connection using Logstash Configuration and Yaml file
